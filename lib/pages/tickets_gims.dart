          ...
          builder: (context, AsyncSnapshot<Event> snap) {
            ...
            return ListView(
              children: <Widget>[
                ...
                Text(snap.data.snapshot.value[2]['question']),
                Image.asset(snap.data.snapshot.value[2]['picture']),
                Text(snap.data.snapshot.value[2]['answers'][0]),
                Text(snap.data.snapshot.value[2]['answers'][1]),
                Text(snap.data.snapshot.value[2]['answers'][2]),
                Text(snap.data.snapshot.value[2]['answers'][3]),
              ],
            );
          }),
    );
            ...
            itemBuilder: (context, index) {
              return Column(
                children: <Widget>[
                  ...
                  RaisedButton(child: Text('следующий вопрос'),
              onPressed: (){}
              ,)
                ],
              );
